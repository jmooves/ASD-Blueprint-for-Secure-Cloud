...
| Password Reset  | Configured                          | For self-service password reset, users will need to provide a mobile app and phone number during registration. To reset their password, they will need to provide two methods of verification.                                                                                                   |
